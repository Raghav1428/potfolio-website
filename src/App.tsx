              ...
              <motion.div variants={fadeUpVariant} className="space-y-4 mb-6">
                <div className="text-gray-300 text-base sm:text-lg leading-relaxed">
                  ...
                  <span className="inline">
                    <ContainerTextFlip
                      words={["GenAI", "APIs", "AI-Agents", "Containerization", "AI-Harness", "Tool Calling"]}
                ...
                <div className="flex items-center gap-2 text-gray-400 flex-wrap mb-2">
                  <span>Currently building an opensource cli</span>
                  <a
                    href="https://knightcode.raghavseth.in/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <span className="text-gray-500"> have a look</span>
                  <a
                    href="https://www.npmjs.com/package/@knightcodeai/cli"
                    target="_blank"
                    rel="noopener noreferrer"
                          ...
                          <div className="flex gap-3 flex-wrap mt-auto">
                            ...
                            {project.npmlink && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full backdrop-blur-lg border border-white/10 bg-gradient-to-tr from-black/60 to-black/40 shadow-lg hover:shadow-2xl hover:shadow-red-500/20 hover:scale-110 active:scale-95 transition-all duration-300 ease-out cursor-pointer hover:border-red-500/30 hover:bg-gradient-to-tr hover:from-white/10 hover:to-black/40 group relative overflow-hidden flex items-center justify-center origin-center"
                              >
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-red-400/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out"></div>

                                <div className="relative z-10 flex items-center justify-center w-full h-full">
                                  <svg
                                    viewBox="0 0 18 7"
                                    className="w-[22px] h-[9px] flex-shrink-0 fill-gray-400 group-hover:fill-[#cb3837] transition-colors duration-300"
                                    aria-hidden="true"
                                  >
                                    <path
                                      fillRule="evenodd"
